...
// than google.protobuf.Empty so parameters can be added later without
// changing the RPC signature.
type GetBlueprintsQuerySchemaRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetBlueprintsQuerySchemaRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type QueryBlueprintsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Query         *v11.Payload           `protobuf:"bytes,1,opt,name=query,proto3" json:"query,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *QueryBlueprintsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type QueryBlueprintsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Blueprints    []*v1.BlueprintSummary `protobuf:"bytes,1,rep,name=blueprints,proto3" json:"blueprints,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *QueryBlueprintsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_provisioner_v1_provisioner_proto_rawDesc = "" +
	...
	"blueprints\"!\n" +
	"\x1fGetBlueprintsQuerySchemaRequest\"A\n" +
	"\x16QueryBlueprintsRequest\x12'\n" +
	"\x05query\x18\x01 \x01(\v2\x11.query.v1.PayloadR\x05query\"V\n" +
	"\x17QueryBlueprintsResponse\x12;\n" +
	"\n" +
	"blueprints\x18\x01 \x03(\v2\x1b.common.v1.BlueprintSummaryR\n" +
	"blueprints\";\n" +
	...
	"\tworkloads\x18\x01 \x03(\v2\x1e.provisioner.v1.InjectWorkloadR\tworkloads2\xd9\x10\n" +
	...
	"\x0eListBlueprints\x12%.provisioner.v1.ListBlueprintsRequest\x1a&.provisioner.v1.ListBlueprintsResponse\x12a\n" +
	"\x18GetBlueprintsQuerySchema\x12/.provisioner.v1.GetBlueprintsQuerySchemaRequest\x1a\x14.query.v1.Descriptor\x12b\n" +
	"\x0fQueryBlueprints\x12&.provisioner.v1.QueryBlueprintsRequest\x1a'.provisioner.v1.QueryBlueprintsResponse\x12Y\n" +
...
var file_provisioner_v1_provisioner_proto_goTypes = []any{
	...
	(*v11.Descriptor)(nil),                  // 43: query.v1.Descriptor
}
var file_provisioner_v1_provisioner_proto_depIdxs = []int32{
	...
	41, // 2: provisioner.v1.ListBlueprintsResponse.blueprints:type_name -> common.v1.BlueprintSummary
	40, // 3: provisioner.v1.QueryBlueprintsRequest.query:type_name -> query.v1.Payload
	41, // 4: provisioner.v1.QueryBlueprintsResponse.blueprints:type_name -> common.v1.BlueprintSummary
	15, // 5: provisioner.v1.ValidateBlueprintResponse.errors:type_name -> provisioner.v1.BlueprintValidationError
	42, // 6: provisioner.v1.OrgBlueprint.created_at:type_name -> google.protobuf.Timestamp
	42, // 7: provisioner.v1.OrgBlueprint.updated_at:type_name -> google.protobuf.Timestamp
	...
	6,  // 16: provisioner.v1.ProvisionerService.ListBlueprints:input_type -> provisioner.v1.ListBlueprintsRequest
	8,  // 17: provisioner.v1.ProvisionerService.GetBlueprintsQuerySchema:input_type -> provisioner.v1.GetBlueprintsQuerySchemaRequest
	9,  // 18: provisioner.v1.ProvisionerService.QueryBlueprints:input_type -> provisioner.v1.QueryBlueprintsRequest
	11, // 19: provisioner.v1.ProvisionerService.GetBlueprint:input_type -> provisioner.v1.GetBlueprintRequest
	13, // 20: provisioner.v1.ProvisionerService.ValidateBlueprint:input_type -> provisioner.v1.ValidateBlueprintRequest
	17, // 21: provisioner.v1.ProvisionerService.CreateBlueprint:input_type -> provisioner.v1.CreateBlueprintRequest
	18, // 22: provisioner.v1.ProvisionerService.UpdateBlueprint:input_type -> provisioner.v1.UpdateBlueprintRequest
	19, // 23: provisioner.v1.ProvisionerService.DeleteBlueprint:input_type -> provisioner.v1.DeleteBlueprintRequest
	...
	43, // 35: provisioner.v1.ProvisionerService.GetWorkspacesQuerySchema:output_type -> query.v1.Descriptor
	3,  // 36: provisioner.v1.ProvisionerService.QueryWorkspaces:output_type -> provisioner.v1.GetWorkspacesResponse
	7,  // 37: provisioner.v1.ProvisionerService.ListBlueprints:output_type -> provisioner.v1.ListBlueprintsResponse
	43, // 38: provisioner.v1.ProvisionerService.GetBlueprintsQuerySchema:output_type -> query.v1.Descriptor
	10, // 39: provisioner.v1.ProvisionerService.QueryBlueprints:output_type -> provisioner.v1.QueryBlueprintsResponse
	12, // 40: provisioner.v1.ProvisionerService.GetBlueprint:output_type -> provisioner.v1.GetBlueprintResponse
	14, // 41: provisioner.v1.ProvisionerService.ValidateBlueprint:output_type -> provisioner.v1.ValidateBlueprintResponse
	16, // 42: provisioner.v1.ProvisionerService.CreateBlueprint:output_type -> provisioner.v1.OrgBlueprint
	16, // 43: provisioner.v1.ProvisionerService.UpdateBlueprint:output_type -> provisioner.v1.OrgBlueprint
	20, // 44: provisioner.v1.ProvisionerService.DeleteBlueprint:output_type -> provisioner.v1.DeleteBlueprintResponse
