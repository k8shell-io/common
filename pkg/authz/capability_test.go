...
var expectedCapabilityActions = []string{
	...
	"user:auth:ssh",
	"user:read:profile",
	"user:read:credentials:kubernetes",
	"user:read:credentials:git",
	"user:read:credentials:registry",
	...
	"workspace:create:inject:catalog",
	"workspace:create:inject:git",
	"workspace:provision:catalog",
	"workspace:provision:git",
	"workspace:read",
	"workspace:update:cpu",
	"workspace:update:memory",
	"workspace:update:network",
	"workspace:delete",
