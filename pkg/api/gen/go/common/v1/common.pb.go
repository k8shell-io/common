...
// OnboardFollowUp describes an optional next step the client should present
// to the user after completing a provider onboarding flow, e.g. prompting a
...
func (x *OnboardFollowUp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnboardFollowUp) ProtoMessage() {}

func (x *OnboardFollowUp) ProtoReflect() protoreflect.Message {
	mi := &file_common_v1_common_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnboardFollowUp.ProtoReflect.Descriptor instead.
func (*OnboardFollowUp) Descriptor() ([]byte, []int) {
	return file_common_v1_common_proto_rawDescGZIP(), []int{7}
}

func (x *OnboardFollowUp) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *OnboardFollowUp) GetDescription() string {
	if x != nil {
...
// user who completed a provider's web onboarding flow, plus an optional
// follow-up action for the client to present.
type CompleteUserWebFlowResult struct {
	...
	FollowUp      *OnboardFollowUp       `protobuf:"bytes,2,opt,name=follow_up,json=followUp,proto3,oneof" json:"follow_up,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CompleteUserWebFlowResult) GetFollowUp() *OnboardFollowUp {
	if x != nil {
		return x.FollowUp
	}
	return nil
...
const file_common_v1_common_proto_rawDesc = "" +
	...
	"\tfollow_up\x18\x02 \x01(\v2\x1a.common.v1.OnboardFollowUpH\x00R\bfollowUp\x88\x01\x01B\f\n" +
	"\n" +
	"_follow_up\"\xc1\x01\n" +
...
var file_common_v1_common_proto_goTypes = []any{
	...
	(*OnboardFollowUp)(nil),           // 7: common.v1.OnboardFollowUp
...
var file_common_v1_common_proto_depIdxs = []int32{
	...
	7,  // 6: common.v1.CompleteUserWebFlowResult.follow_up:type_name -> common.v1.OnboardFollowUp
