...
var file_identity_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_identity_v1_types_proto_goTypes = []any{
	...
	(*AuthUserPasswordRequest)(nil),      // 8: identity.v1.AuthUserPasswordRequest
	(*AuthUserResponse)(nil),             // 9: identity.v1.AuthUserResponse
	(*PasswordLockoutStatus)(nil),        // 10: identity.v1.PasswordLockoutStatus
	(*ClearPasswordLockoutResponse)(nil), // 11: identity.v1.ClearPasswordLockoutResponse
	...
	(*IdentityProviderInfo)(nil),         // 17: identity.v1.IdentityProviderInfo
	(*UserRolesRequest)(nil),             // 18: identity.v1.UserRolesRequest
	(*UserBlueprintsRequest)(nil),        // 19: identity.v1.UserBlueprintsRequest
	(*UserAuthKeysRequest)(nil),          // 20: identity.v1.UserAuthKeysRequest
	(*UserAuthKey)(nil),                  // 21: identity.v1.UserAuthKey
	(*ListUserAuthKeysResponse)(nil),     // 22: identity.v1.ListUserAuthKeysResponse
...
var file_identity_v1_types_proto_depIdxs = []int32{
	24, // 0: identity.v1.UserList.users:type_name -> common.v1.User
	24, // 1: identity.v1.GetUsersResponse.users:type_name -> common.v1.User
	24, // 2: identity.v1.AuthUserResponse.user:type_name -> common.v1.User
	21, // 3: identity.v1.ListUserAuthKeysResponse.auth_keys:type_name -> identity.v1.UserAuthKey
	25, // 4: identity.v1.AccessTokenInfo.expires_at:type_name -> google.protobuf.Timestamp
	25, // 5: identity.v1.AccessTokenInfo.created_at:type_name -> google.protobuf.Timestamp
	25, // 6: identity.v1.AccessTokenInfo.last_used_at:type_name -> google.protobuf.Timestamp
