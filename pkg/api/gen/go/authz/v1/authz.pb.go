...
type AuditRecord struct {
	...
	LastOccurredAt *timestamp.Timestamp `protobuf:"bytes,19,opt,name=last_occurred_at,json=lastOccurredAt,proto3" json:"last_occurred_at,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *AuditRecord) GetOccurredAt() *timestamp.Timestamp {
	if x != nil {
		return x.OccurredAt
	}
	return nil
...
func (x *AuditRecord) GetLastOccurredAt() *timestamp.Timestamp {
	if x != nil {
