...
type WorkspaceDetails struct {
	...
	// injected into (e.g. "Deployment", "StatefulSet"). Set only when
...
const file_common_v1_common_proto_rawDesc = "" +
	...
	"\x11last_fail_message\x18\x05 \x01(\tR\x0flastFailMessage\"\xb4\x05\n" +
	...
	"\rworkload_name\x18\x17 \x01(\tR\fworkloadName\"i\n" +
