...
func TestScopeForRequest(t *testing.T) {
	tests := []struct {
		...
		{"workspace:create standalone catalog", "workspace:create",
			map[string]string{"mode": "standalone", "source": "catalog"}, "workspace:create:standalone:catalog"},
		{"workspace:create inject git", "workspace:create",
			map[string]string{"mode": "inject", "source": "git"}, "workspace:create:inject:git"},
		{"workspace:provision git", "workspace:provision", map[string]string{"source": "git"}, "workspace:provision:git"},
		{"workspace:provision catalog", "workspace:provision", map[string]string{"source": "catalog"}, "workspace:provision:catalog"},
