...
func (x *WorkspaceResourceLimits) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WorkspaceResourceLimits) GetMemory() string {
	if x != nil {
		return x.Memory
	}
	return ""
...
func (x *WorkspacePodSelector) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type WorkspaceNetworkRules struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	NetworkPolicyClass string `protobuf:"bytes,1,opt,name=network_policy_class,json=networkPolicyClass,proto3" json:"network_policy_class,omitempty"`
	...
	ReplaceEgress bool `protobuf:"varint,2,opt,name=replace_egress,json=replaceEgress,proto3" json:"replace_egress,omitempty"`
	// allow_egress_to_cidrs is the set of CIDR ranges the workspace may reach.
	// Applied only when replace_egress is true.
	AllowEgressToCidrs []string `protobuf:"bytes,3,rep,name=allow_egress_to_cidrs,json=allowEgressToCidrs,proto3" json:"allow_egress_to_cidrs,omitempty"`
...
func (x *WorkspaceNetworkRules) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WorkspaceNetworkRules) GetReplaceEgress() bool {
	if x != nil {
		return x.ReplaceEgress
	}
	return false
}

func (x *WorkspaceNetworkRules) GetAllowEgressToCidrs() []string {
	if x != nil {
...
type UpdateWorkspaceResourcesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// workspace is the name of the workspace to update.
	Workspace string `protobuf:"bytes,1,opt,name=workspace,proto3" json:"workspace,omitempty"`
	// resources, when set, changes the workspace's CPU/memory limits.
	Resources *WorkspaceResourceLimits `protobuf:"bytes,2,opt,name=resources,proto3" json:"resources,omitempty"`
	// network, when set, changes the workspace's network policy class and/or
	// egress rules.
	Network       *WorkspaceNetworkRules `protobuf:"bytes,3,opt,name=network,proto3" json:"network,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateWorkspaceResourcesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpdateWorkspaceResourcesRequest) GetResources() *WorkspaceResourceLimits {
	if x != nil {
		return x.Resources
	}
	return nil
...
func (x *UpdateWorkspaceResourcesRequest) GetNetwork() *WorkspaceNetworkRules {
	if x != nil {
		return x.Network
	}
	return nil
...
// update.
type UpdateWorkspaceResourcesResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	// after the update.
	AppliedCpu    string `protobuf:"bytes,2,opt,name=applied_cpu,json=appliedCpu,proto3" json:"applied_cpu,omitempty"`
	AppliedMemory string `protobuf:"bytes,3,opt,name=applied_memory,json=appliedMemory,proto3" json:"applied_memory,omitempty"`
...
func (x *UpdateWorkspaceResourcesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpdateWorkspaceResourcesResponse) GetAppliedCpu() string {
	if x != nil {
		return x.AppliedCpu
	}
	return ""
...
func (x *UpdateWorkspaceResourcesResponse) GetAppliedMemory() string {
	if x != nil {
		return x.AppliedMemory
	}
	return ""
}

func (x *UpdateWorkspaceResourcesResponse) GetAppliedNetworkPolicyClass() string {
	if x != nil {
...
const file_provisioner_v1_provisioner_proto_rawDesc = "" +
	...
	"\x17WorkspaceResourceLimits\x12\x10\n" +
	"\x03cpu\x18\x01 \x01(\tR\x03cpu\x12\x16\n" +
	"\x06memory\x18\x02 \x01(\tR\x06memory\"\xb0\x01\n" +
	"\x14WorkspacePodSelector\x12X\n" +
	...
	"\rStopWorkspace\x12$.provisioner.v1.StopWorkspaceRequest\x1a%.provisioner.v1.StopWorkspaceResponse\x12}\n" +
	"\x18UpdateWorkspaceResources\x12/.provisioner.v1.UpdateWorkspaceResourcesRequest\x1a0.provisioner.v1.UpdateWorkspaceResourcesResponse\x12k\n" +
