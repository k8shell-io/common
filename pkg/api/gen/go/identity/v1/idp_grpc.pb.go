...
type IdentityProviderServiceClient interface {
	...
	// the user plus an optional follow-up action for the client to present.
	CompleteUserWebFlow(ctx context.Context, in *CompleteUserWebFlowRequest, opts ...grpc.CallOption) (*v1.CompleteUserWebFlowResult, error)
...
func (c *identityProviderServiceClient) CompleteUserWebFlow(ctx context.Context, in *CompleteUserWebFlowRequest, opts ...grpc.CallOption) (*v1.CompleteUserWebFlowResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.CompleteUserWebFlowResult)
...
type IdentityProviderServiceServer interface {
	...
	// provided state and code, returning the onboarding decision computed for
	// the user plus an optional follow-up action for the client to present.
	CompleteUserWebFlow(context.Context, *CompleteUserWebFlowRequest) (*v1.CompleteUserWebFlowResult, error)
	// AuthUserPublicKey authenticates a user using a public key and returns the authentication result
...
func (UnimplementedIdentityProviderServiceServer) CompleteUserWebFlow(context.Context, *CompleteUserWebFlowRequest) (*v1.CompleteUserWebFlowResult, error) {
