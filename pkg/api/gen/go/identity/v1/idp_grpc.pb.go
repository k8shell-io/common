...
type IdentityProviderServiceClient interface {
	...
	// FindUser retrieves a user by username, re-evaluating the provider's
	// onboarding decision for them. It can be used for authentication and user
	// lookup.
	FindUser(ctx context.Context, in *FindUserRequest, opts ...grpc.CallOption) (*v1.UserResult, error)
	...
	// CompleteUserWebFlow completes the web flow onboarding process using the
	// provided state and code, returning the onboarding decision computed for
	// the user plus optional management info for the client to present.
	CompleteUserWebFlow(ctx context.Context, in *CompleteUserWebFlowRequest, opts ...grpc.CallOption) (*v1.UserResult, error)
...
func (c *identityProviderServiceClient) FindUser(ctx context.Context, in *FindUserRequest, opts ...grpc.CallOption) (*v1.UserResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.UserResult)
...
func (c *identityProviderServiceClient) CompleteUserWebFlow(ctx context.Context, in *CompleteUserWebFlowRequest, opts ...grpc.CallOption) (*v1.UserResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.UserResult)
...
type IdentityProviderServiceServer interface {
	...
	// onboarding decision for them. It can be used for authentication and user
	// lookup.
	FindUser(context.Context, *FindUserRequest) (*v1.UserResult, error)
	// OnboardCapability returns the onboarding capability details for a user.
	...
	// provided state and code, returning the onboarding decision computed for
	// the user plus optional management info for the client to present.
	CompleteUserWebFlow(context.Context, *CompleteUserWebFlowRequest) (*v1.UserResult, error)
	// AuthUserPublicKey authenticates a user using a public key and returns the authentication result
...
func (UnimplementedIdentityProviderServiceServer) FindUser(context.Context, *FindUserRequest) (*v1.UserResult, error) {
...
func (UnimplementedIdentityProviderServiceServer) CompleteUserWebFlow(context.Context, *CompleteUserWebFlowRequest) (*v1.UserResult, error) {
