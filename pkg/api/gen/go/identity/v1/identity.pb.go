...
const file_identity_v1_identity_proto_rawDesc = "" +
	...
	"\x16AUTH_KEY_FORMAT_DIGEST\x10\x022\xf3\x1b\n" +
...
var file_identity_v1_identity_proto_goTypes = []any{
	...
	(*PasswordLockoutStatus)(nil),                 // 68: identity.v1.PasswordLockoutStatus
	(*ClearPasswordLockoutResponse)(nil),          // 69: identity.v1.ClearPasswordLockoutResponse
	(*Blueprint)(nil),                             // 70: identity.v1.Blueprint
	(*ListUserAuthKeysResponse)(nil),              // 71: identity.v1.ListUserAuthKeysResponse
}
var file_identity_v1_identity_proto_depIdxs = []int32{
	...
	53, // 36: identity.v1.IdentityService.GetPasswordLockoutStatus:input_type -> identity.v1.Username
	53, // 37: identity.v1.IdentityService.ClearPasswordLockout:input_type -> identity.v1.Username
	10, // 38: identity.v1.IdentityService.CompleteUserDeviceFlow:input_type -> identity.v1.CompleteUserDeviceFlowRequest
	59, // 39: identity.v1.IdentityService.GetBlueprintByUserStr:input_type -> identity.v1.UserStr
	13, // 40: identity.v1.IdentityService.ListUserCredentials:input_type -> identity.v1.ListUserCredentialsRequest
	15, // 41: identity.v1.IdentityService.GetUserCredential:input_type -> identity.v1.GetUserCredentialRequest
	16, // 42: identity.v1.IdentityService.AddKubernetesUserCredential:input_type -> identity.v1.AddKubernetesUserCredentialRequest
	18, // 43: identity.v1.IdentityService.AddGitUserCredential:input_type -> identity.v1.AddGitUserCredentialRequest
	20, // 44: identity.v1.IdentityService.AddRegistryUserCredential:input_type -> identity.v1.AddRegistryUserCredentialRequest
	3,  // 45: identity.v1.IdentityService.CreateUser:input_type -> identity.v1.CreateUserRequest
	4,  // 46: identity.v1.IdentityService.UpdateUser:input_type -> identity.v1.UpdateUserRequest
	5,  // 47: identity.v1.IdentityService.DeleteUser:input_type -> identity.v1.DeleteUserRequest
	60, // 48: identity.v1.IdentityService.AddUserRoles:input_type -> identity.v1.UserRolesRequest
	60, // 49: identity.v1.IdentityService.RemoveUserRoles:input_type -> identity.v1.UserRolesRequest
	61, // 50: identity.v1.IdentityService.AddUserBlueprints:input_type -> identity.v1.UserBlueprintsRequest
	61, // 51: identity.v1.IdentityService.RemoveUserBlueprints:input_type -> identity.v1.UserBlueprintsRequest
	1,  // 52: identity.v1.IdentityService.ListUserAuthKeys:input_type -> identity.v1.ListUserAuthKeysRequest
	62, // 53: identity.v1.IdentityService.AddUserAuthKeys:input_type -> identity.v1.UserAuthKeysRequest
	2,  // 54: identity.v1.IdentityService.RemoveUserAuthKey:input_type -> identity.v1.RemoveUserAuthKeyRequest
	7,  // 55: identity.v1.IdentityService.SetUserPassword:input_type -> identity.v1.SetUserPasswordRequest
	22, // 56: identity.v1.IdentityService.UpdateUserCredential:input_type -> identity.v1.UpdateUserCredentialRequest
	24, // 57: identity.v1.IdentityService.DeleteUserCredential:input_type -> identity.v1.DeleteUserCredentialRequest
	26, // 58: identity.v1.IdentityService.RemoveUserCredential:input_type -> identity.v1.RemoveUserCredentialRequest
	28, // 59: identity.v1.IdentityService.GetAvailableIdentityProviders:input_type -> identity.v1.GetAvailableIdentityProvidersRequest
	30, // 60: identity.v1.IdentityService.CreateAccessToken:input_type -> identity.v1.CreateAccessTokenRequest
	33, // 61: identity.v1.IdentityService.UpdateAccessToken:input_type -> identity.v1.UpdateAccessTokenRequest
	53, // 62: identity.v1.IdentityService.ListAccessTokens:input_type -> identity.v1.Username
	36, // 63: identity.v1.IdentityService.RevokeAccessToken:input_type -> identity.v1.RevokeAccessTokenRequest
	38, // 64: identity.v1.IdentityService.DeleteAccessToken:input_type -> identity.v1.DeleteAccessTokenRequest
	40, // 65: identity.v1.IdentityService.ResolveAccessToken:input_type -> identity.v1.ResolveAccessTokenRequest
	50, // 66: identity.v1.IdentityService.FindUser:output_type -> common.v1.User
	63, // 67: identity.v1.IdentityService.GetUsers:output_type -> identity.v1.UserList
	9,  // 68: identity.v1.IdentityService.IssueUserToken:output_type -> identity.v1.IssueUserTokenResponse
	64, // 69: identity.v1.IdentityService.GetUserOnboardCapability:output_type -> common.v1.UserOnboardCapability
	65, // 70: identity.v1.IdentityService.OnboardUserDeviceFlow:output_type -> common.v1.OnboardUserDeviceFlow
	66, // 71: identity.v1.IdentityService.OnboardUserWebFlow:output_type -> common.v1.OnboardUserWebFlow
	12, // 72: identity.v1.IdentityService.CompleteUserWebFlow:output_type -> identity.v1.CompleteUserWebFlowResponse
	67, // 73: identity.v1.IdentityService.AuthUserPublicKey:output_type -> identity.v1.AuthUserResponse
	67, // 74: identity.v1.IdentityService.AuthUserPassword:output_type -> identity.v1.AuthUserResponse
	68, // 75: identity.v1.IdentityService.GetPasswordLockoutStatus:output_type -> identity.v1.PasswordLockoutStatus
	69, // 76: identity.v1.IdentityService.ClearPasswordLockout:output_type -> identity.v1.ClearPasswordLockoutResponse
	11, // 77: identity.v1.IdentityService.CompleteUserDeviceFlow:output_type -> identity.v1.CompleteUserDeviceFlowResponse
	70, // 78: identity.v1.IdentityService.GetBlueprintByUserStr:output_type -> identity.v1.Blueprint
	14, // 79: identity.v1.IdentityService.ListUserCredentials:output_type -> identity.v1.ListUserCredentialsResponse
	45, // 80: identity.v1.IdentityService.GetUserCredential:output_type -> common.v1.UserCredential
	17, // 81: identity.v1.IdentityService.AddKubernetesUserCredential:output_type -> identity.v1.AddKubernetesUserCredentialResponse
	19, // 82: identity.v1.IdentityService.AddGitUserCredential:output_type -> identity.v1.AddGitUserCredentialResponse
	21, // 83: identity.v1.IdentityService.AddRegistryUserCredential:output_type -> identity.v1.AddRegistryUserCredentialResponse
	50, // 84: identity.v1.IdentityService.CreateUser:output_type -> common.v1.User
	50, // 85: identity.v1.IdentityService.UpdateUser:output_type -> common.v1.User
	6,  // 86: identity.v1.IdentityService.DeleteUser:output_type -> identity.v1.DeleteUserResponse
	50, // 87: identity.v1.IdentityService.AddUserRoles:output_type -> common.v1.User
	50, // 88: identity.v1.IdentityService.RemoveUserRoles:output_type -> common.v1.User
	50, // 89: identity.v1.IdentityService.AddUserBlueprints:output_type -> common.v1.User
	50, // 90: identity.v1.IdentityService.RemoveUserBlueprints:output_type -> common.v1.User
	71, // 91: identity.v1.IdentityService.ListUserAuthKeys:output_type -> identity.v1.ListUserAuthKeysResponse
	50, // 92: identity.v1.IdentityService.AddUserAuthKeys:output_type -> common.v1.User
	50, // 93: identity.v1.IdentityService.RemoveUserAuthKey:output_type -> common.v1.User
	50, // 94: identity.v1.IdentityService.SetUserPassword:output_type -> common.v1.User
	23, // 95: identity.v1.IdentityService.UpdateUserCredential:output_type -> identity.v1.UpdateUserCredentialResponse
	25, // 96: identity.v1.IdentityService.DeleteUserCredential:output_type -> identity.v1.DeleteUserCredentialResponse
	27, // 97: identity.v1.IdentityService.RemoveUserCredential:output_type -> identity.v1.RemoveUserCredentialResponse
	29, // 98: identity.v1.IdentityService.GetAvailableIdentityProviders:output_type -> identity.v1.GetAvailableIdentityProvidersResponse
	31, // 99: identity.v1.IdentityService.CreateAccessToken:output_type -> identity.v1.CreateAccessTokenResponse
	34, // 100: identity.v1.IdentityService.UpdateAccessToken:output_type -> identity.v1.UpdateAccessTokenResponse
	35, // 101: identity.v1.IdentityService.ListAccessTokens:output_type -> identity.v1.ListAccessTokensResponse
	37, // 102: identity.v1.IdentityService.RevokeAccessToken:output_type -> identity.v1.RevokeAccessTokenResponse
	39, // 103: identity.v1.IdentityService.DeleteAccessToken:output_type -> identity.v1.DeleteAccessTokenResponse
	41, // 104: identity.v1.IdentityService.ResolveAccessToken:output_type -> identity.v1.ResolveAccessTokenResponse
