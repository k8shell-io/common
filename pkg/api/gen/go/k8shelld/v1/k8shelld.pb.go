...
type ShellStartRequest struct {
	...
	DetachOnClose bool                   `protobuf:"varint,9,opt,name=detach_on_close,json=detachOnClose,proto3" json:"detach_on_close,omitempty"` // trueto continue the session after the client disconnects
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_k8shelld_v1_k8shelld_proto_rawDesc = "" +
	...
	"\x0fdetach_on_close\x18\t \x01(\bR\rdetachOnClose\"&\n" +
