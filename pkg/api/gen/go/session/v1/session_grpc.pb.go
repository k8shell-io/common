...
type SessionServiceClient interface {
	...
	// and end time.
	EndSession(ctx context.Context, in *EndSessionRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *sessionServiceClient) EndSession(ctx context.Context, in *EndSessionRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type SessionServiceServer interface {
	...
	// EndSession marks a session as ended, recording its final byte counts
	// and end time.
	EndSession(context.Context, *EndSessionRequest) (*empty.Empty, error)
	// GetVersionInfo returns build and version metadata for this service: its
	// released semantic version, the git commit it was built from, and a short
	// description of what the service does.
...
func (UnimplementedSessionServiceServer) EndSession(context.Context, *EndSessionRequest) (*empty.Empty, error) {
...
type RecordingServiceClient interface {
	...
	StreamShellRecording(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ShellRecordingFrame, empty.Empty], error)
	...
	StreamExecRecording(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ExecRecordingFrame, empty.Empty], error)
	...
	StreamTcpipRecording(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TcpipRecordingFrame, empty.Empty], error)
	...
	StreamSftpRecording(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SftpRecordingFrame, empty.Empty], error)
	...
	EndRecordingSession(ctx context.Context, in *EndRecordingSessionRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *recordingServiceClient) StreamShellRecording(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ShellRecordingFrame, empty.Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[ShellRecordingFrame, empty.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RecordingService_StreamShellRecordingClient = grpc.ClientStreamingClient[ShellRecordingFrame, empty.Empty]

func (c *recordingServiceClient) StreamExecRecording(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ExecRecordingFrame, empty.Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[ExecRecordingFrame, empty.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RecordingService_StreamExecRecordingClient = grpc.ClientStreamingClient[ExecRecordingFrame, empty.Empty]

func (c *recordingServiceClient) StreamTcpipRecording(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TcpipRecordingFrame, empty.Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[TcpipRecordingFrame, empty.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RecordingService_StreamTcpipRecordingClient = grpc.ClientStreamingClient[TcpipRecordingFrame, empty.Empty]

func (c *recordingServiceClient) StreamSftpRecording(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SftpRecordingFrame, empty.Empty], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[SftpRecordingFrame, empty.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RecordingService_StreamSftpRecordingClient = grpc.ClientStreamingClient[SftpRecordingFrame, empty.Empty]

func (c *recordingServiceClient) EndRecordingSession(ctx context.Context, in *EndRecordingSessionRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type RecordingServiceServer interface {
	...
	// be a ShellRecordingHeader; subsequent frames carry data chunks or
	// terminal resize events.
	StreamShellRecording(grpc.ClientStreamingServer[ShellRecordingFrame, empty.Empty]) error
	// StreamExecRecording records a non-PTY exec channel. The first frame must
	// be an ExecRecordingHeader; subsequent frames carry data chunks.
	StreamExecRecording(grpc.ClientStreamingServer[ExecRecordingFrame, empty.Empty]) error
	// StreamTcpipRecording records a direct-tcpip port-forward channel. The
	// first frame must be a TcpipRecordingHeader; subsequent frames carry data chunks.
	StreamTcpipRecording(grpc.ClientStreamingServer[TcpipRecordingFrame, empty.Empty]) error
	// StreamSftpRecording records an SFTP subsystem channel. The first frame
	// must be a SftpRecordingHeader; subsequent frames carry data chunks.
	StreamSftpRecording(grpc.ClientStreamingServer[SftpRecordingFrame, empty.Empty]) error
	// EndRecordingSession notifies the recording backend that a session has ended
	// and all associated recording resources (open streams, buffers, file handles)
	// should be flushed and released. Must be called once per session_id when the
	// SSH session terminates, regardless of how many recording streams were opened.
	EndRecordingSession(context.Context, *EndRecordingSessionRequest) (*empty.Empty, error)
...
func (UnimplementedRecordingServiceServer) StreamShellRecording(grpc.ClientStreamingServer[ShellRecordingFrame, empty.Empty]) error {
	return status.Error(codes.Unimplemented, "method StreamShellRecording not implemented")
}
func (UnimplementedRecordingServiceServer) StreamExecRecording(grpc.ClientStreamingServer[ExecRecordingFrame, empty.Empty]) error {
	return status.Error(codes.Unimplemented, "method StreamExecRecording not implemented")
}
func (UnimplementedRecordingServiceServer) StreamTcpipRecording(grpc.ClientStreamingServer[TcpipRecordingFrame, empty.Empty]) error {
	return status.Error(codes.Unimplemented, "method StreamTcpipRecording not implemented")
}
func (UnimplementedRecordingServiceServer) StreamSftpRecording(grpc.ClientStreamingServer[SftpRecordingFrame, empty.Empty]) error {
	return status.Error(codes.Unimplemented, "method StreamSftpRecording not implemented")
}
func (UnimplementedRecordingServiceServer) EndRecordingSession(context.Context, *EndRecordingSessionRequest) (*empty.Empty, error) {
...
func _RecordingService_StreamShellRecording_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RecordingServiceServer).StreamShellRecording(&grpc.GenericServerStream[ShellRecordingFrame, empty.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RecordingService_StreamShellRecordingServer = grpc.ClientStreamingServer[ShellRecordingFrame, empty.Empty]

func _RecordingService_StreamExecRecording_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RecordingServiceServer).StreamExecRecording(&grpc.GenericServerStream[ExecRecordingFrame, empty.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RecordingService_StreamExecRecordingServer = grpc.ClientStreamingServer[ExecRecordingFrame, empty.Empty]

func _RecordingService_StreamTcpipRecording_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RecordingServiceServer).StreamTcpipRecording(&grpc.GenericServerStream[TcpipRecordingFrame, empty.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RecordingService_StreamTcpipRecordingServer = grpc.ClientStreamingServer[TcpipRecordingFrame, empty.Empty]

func _RecordingService_StreamSftpRecording_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RecordingServiceServer).StreamSftpRecording(&grpc.GenericServerStream[SftpRecordingFrame, empty.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RecordingService_StreamSftpRecordingServer = grpc.ClientStreamingServer[SftpRecordingFrame, empty.Empty]
