...
const file_provisioner_v1_provisioner_proto_rawDesc = "" +
	"\n" +
	" provisioner/v1/provisioner.proto\x12\x0eprovisioner.v1\x1a\x16common/v1/common.proto\x1a\x14query/v1/query.proto\"4\n" +
	...
	"\btemplate\x18\x03 \x01(\tR\btemplate\"\x95\x01\n" +
	...
	"\tworkloads\x18\x01 \x03(\v2\x1e.provisioner.v1.InjectWorkloadR\tworkloads2\x8f\f\n" +
	...
	"\fGetBlueprint\x12#.provisioner.v1.GetBlueprintRequest\x1a$.provisioner.v1.GetBlueprintResponse\x12s\n" +
...
var file_provisioner_v1_provisioner_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_provisioner_v1_provisioner_proto_goTypes = []any{
	...
	(*ProvisionWorkspaceRequest)(nil),       // 10: provisioner.v1.ProvisionWorkspaceRequest
	(*ProvisionWorkspaceResponse)(nil),      // 11: provisioner.v1.ProvisionWorkspaceResponse
	(*HandshakeResponse)(nil),               // 12: provisioner.v1.HandshakeResponse
	(*ProvisionEvent)(nil),                  // 13: provisioner.v1.ProvisionEvent
	(*DeleteWorkspaceRequest)(nil),          // 14: provisioner.v1.DeleteWorkspaceRequest
	(*DeleteWorkspaceResponse)(nil),         // 15: provisioner.v1.DeleteWorkspaceResponse
	(*DeleteUserWorkspacesRequest)(nil),     // 16: provisioner.v1.DeleteUserWorkspacesRequest
	(*DeleteUserWorkspacesResponse)(nil),    // 17: provisioner.v1.DeleteUserWorkspacesResponse
	(*StopWorkspaceRequest)(nil),            // 18: provisioner.v1.StopWorkspaceRequest
	(*StopWorkspaceResponse)(nil),           // 19: provisioner.v1.StopWorkspaceResponse
	(*StartWorkspaceRequest)(nil),           // 20: provisioner.v1.StartWorkspaceRequest
	(*EjectWorkspaceRequest)(nil),           // 21: provisioner.v1.EjectWorkspaceRequest
	(*EjectWorkspaceResponse)(nil),          // 22: provisioner.v1.EjectWorkspaceResponse
	(*ListInjectNamespacesRequest)(nil),     // 23: provisioner.v1.ListInjectNamespacesRequest
	(*ListInjectNamespacesResponse)(nil),    // 24: provisioner.v1.ListInjectNamespacesResponse
	(*ListInjectWorkloadsRequest)(nil),      // 25: provisioner.v1.ListInjectWorkloadsRequest
	(*InjectWorkload)(nil),                  // 26: provisioner.v1.InjectWorkload
	(*ListInjectWorkloadsResponse)(nil),     // 27: provisioner.v1.ListInjectWorkloadsResponse
	(*v1.WorkspaceDetails)(nil),             // 28: common.v1.WorkspaceDetails
	(*v11.Payload)(nil),                     // 29: query.v1.Payload
	(*v1.BlueprintSummary)(nil),             // 30: common.v1.BlueprintSummary
	(*v11.Descriptor)(nil),                  // 31: query.v1.Descriptor
}
var file_provisioner_v1_provisioner_proto_depIdxs = []int32{
	28, // 0: provisioner.v1.GetWorkspacesResponse.workspaces:type_name -> common.v1.WorkspaceDetails
	29, // 1: provisioner.v1.QueryWorkspacesRequest.query:type_name -> query.v1.Payload
	30, // 2: provisioner.v1.GetBlueprintsResponse.blueprints:type_name -> common.v1.BlueprintSummary
	12, // 3: provisioner.v1.ProvisionWorkspaceResponse.handshake:type_name -> provisioner.v1.HandshakeResponse
	13, // 4: provisioner.v1.ProvisionWorkspaceResponse.event:type_name -> provisioner.v1.ProvisionEvent
	26, // 5: provisioner.v1.ListInjectWorkloadsResponse.workloads:type_name -> provisioner.v1.InjectWorkload
	...
	8,  // 12: provisioner.v1.ProvisionerService.GetBlueprint:input_type -> provisioner.v1.GetBlueprintRequest
	10, // 13: provisioner.v1.ProvisionerService.ProvisionWorkspaceStream:input_type -> provisioner.v1.ProvisionWorkspaceRequest
	14, // 14: provisioner.v1.ProvisionerService.DeleteWorkspace:input_type -> provisioner.v1.DeleteWorkspaceRequest
	16, // 15: provisioner.v1.ProvisionerService.DeleteUserWorkspaces:input_type -> provisioner.v1.DeleteUserWorkspacesRequest
	18, // 16: provisioner.v1.ProvisionerService.StopWorkspace:input_type -> provisioner.v1.StopWorkspaceRequest
	20, // 17: provisioner.v1.ProvisionerService.StartWorkspaceStream:input_type -> provisioner.v1.StartWorkspaceRequest
	21, // 18: provisioner.v1.ProvisionerService.EjectWorkspace:input_type -> provisioner.v1.EjectWorkspaceRequest
	23, // 19: provisioner.v1.ProvisionerService.ListInjectNamespaces:input_type -> provisioner.v1.ListInjectNamespacesRequest
	25, // 20: provisioner.v1.ProvisionerService.ListInjectWorkloads:input_type -> provisioner.v1.ListInjectWorkloadsRequest
	3,  // 21: provisioner.v1.ProvisionerService.GetWorkspaces:output_type -> provisioner.v1.GetWorkspacesResponse
	28, // 22: provisioner.v1.ProvisionerService.FindWorkspace:output_type -> common.v1.WorkspaceDetails
	3,  // 23: provisioner.v1.ProvisionerService.GetWorkspacesByUserStr:output_type -> provisioner.v1.GetWorkspacesResponse
	31, // 24: provisioner.v1.ProvisionerService.GetWorkspacesQuerySchema:output_type -> query.v1.Descriptor
	3,  // 25: provisioner.v1.ProvisionerService.QueryWorkspaces:output_type -> provisioner.v1.GetWorkspacesResponse
	7,  // 26: provisioner.v1.ProvisionerService.GetBlueprints:output_type -> provisioner.v1.GetBlueprintsResponse
	9,  // 27: provisioner.v1.ProvisionerService.GetBlueprint:output_type -> provisioner.v1.GetBlueprintResponse
	11, // 28: provisioner.v1.ProvisionerService.ProvisionWorkspaceStream:output_type -> provisioner.v1.ProvisionWorkspaceResponse
	15, // 29: provisioner.v1.ProvisionerService.DeleteWorkspace:output_type -> provisioner.v1.DeleteWorkspaceResponse
	17, // 30: provisioner.v1.ProvisionerService.DeleteUserWorkspaces:output_type -> provisioner.v1.DeleteUserWorkspacesResponse
	19, // 31: provisioner.v1.ProvisionerService.StopWorkspace:output_type -> provisioner.v1.StopWorkspaceResponse
	11, // 32: provisioner.v1.ProvisionerService.StartWorkspaceStream:output_type -> provisioner.v1.ProvisionWorkspaceResponse
	22, // 33: provisioner.v1.ProvisionerService.EjectWorkspace:output_type -> provisioner.v1.EjectWorkspaceResponse
	24, // 34: provisioner.v1.ProvisionerService.ListInjectNamespaces:output_type -> provisioner.v1.ListInjectNamespacesResponse
	27, // 35: provisioner.v1.ProvisionerService.ListInjectWorkloads:output_type -> provisioner.v1.ListInjectWorkloadsResponse
...
func file_provisioner_v1_provisioner_proto_init() {
	...
	file_provisioner_v1_provisioner_proto_msgTypes[11].OneofWrappers = []any{
